...
PERMISSION_CATALOG: list[tuple[str, str, str]] = [
    ...
    # PROGRAMS & COURSES (program-based)
    ("programs.read", "View programs", "PROGRAMS"),
    ("programs.manage", "Manage programs", "PROGRAMS"),
    ("courses.read", "View courses", "PROGRAMS"),
    ("courses.manage", "Manage courses", "PROGRAMS"),
    ("student_groups.read", "View student groups", "PROGRAMS"),
    ("student_groups.manage", "Manage student groups", "PROGRAMS"),
    ("enrollments.read", "View enrollments", "PROGRAMS"),
    ("enrollments.manage", "Manage enrollments", "PROGRAMS"),
    # OPERATIONS
    ...
    ("leave.read", "View leave requests", "OPERATIONS"),
    ("leave.manage", "Manage leave requests", "OPERATIONS"),
    ("rooms.read", "View rooms", "OPERATIONS"),
    ("rooms.manage", "Manage rooms", "OPERATIONS"),
    ("instructors.read", "View instructors", "OPERATIONS"),
    ("instructors.manage", "Manage instructors", "OPERATIONS"),
    ("course_schedules.read", "View course schedules", "OPERATIONS"),
    ("course_schedules.manage", "Manage course schedules", "OPERATIONS"),
    ...
    # COMMUNITY / EXTRAS
    ("clubs.read", "View clubs", "COMMUNITY"),
    ("clubs.manage", "Manage clubs", "COMMUNITY"),
    ("applicants.read", "View applicants", "ADMISSIONS"),
    ("applicants.manage", "Manage applicants", "ADMISSIONS"),
    ("guardians.read", "View guardians", "STUDENTS"),
    ("guardians.manage", "Manage guardians", "STUDENTS"),
    # SYSTEM
