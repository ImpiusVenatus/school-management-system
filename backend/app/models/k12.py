...
class K12StudentEnrollment(Base):
    ...
    stream = Column(String(20), nullable=True)  # Science / Commerce / Arts (required for class 9+)
...
class K12TimetableSlot(Base):
    ...
    stream = Column(String(20), nullable=True)  # Science / Commerce / Arts (optional; enables stream-specific periods)
